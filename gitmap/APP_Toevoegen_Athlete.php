...
<div id="field">
    <form name="form1" method="post" action="" enctype="multipart/form-data">
        ...
        <input type="number" name="athlete_height" placeholder="0cm" required><br>
...
<div id="field">
    ...
    if (isset($_POST['add_athlete'])) {
        ...
        $query = "INSERT INTO athletes (athlete_firstname, athlete_lastname, athlete_nickname, athlete_gender, athlete_picture, athlete_height, athlete_weight, athlete_weightclass, athlete_grade, athlete_nationality, 
  			  ...
  			  VALUES('$athlete_firstname', '$athlete_lastname', '$athlete_nickname', '$athlete_gender', '$dst', '$athlete_height', '$athlete_weight', '$athlete_weightclass', '$athlete_grade', '$athlete_nationality',
  			         '$athlete_day_of_birth', '$athlete_description', '$athlete_email', '$athlete_phone1', '$athlete_phone2', 
  			         '$athlete_adress', '$athlete_postal_code', '$athlete_city', '$athlete_facebook', '$athlete_twitter', '$athlete_instagram', '$athlete_linkedin', '$athlete_youtube')";
